	...
	<div class="row">
			...
			<div class="card text-bg-primary shadow">
				<div class="card-body card-stats">
					<div class="description">
						...
						<?php
						$persen = (!empty($total_jumlah_presensi[$tahun]) && !empty($presensi_pertahun[$tahun]['tepat_waktu']))
							? round($presensi_pertahun[$tahun]['tepat_waktu'] / $total_jumlah_presensi[$tahun], 2) * 100
							: 0;
						?>
						...
						<div class="icon me-2">
							<?php
								...
								if (!empty($presensi_pertahun[$tahun]['tepat_waktu'])) {
									$exists = true;
									$growth = (!empty($presensi_pertahun[$tahun_prev]['tepat_waktu']) && $presensi_pertahun[$tahun_prev]['tepat_waktu'] != 0)
										? ($presensi_pertahun[$tahun]['tepat_waktu'] - $presensi_pertahun[$tahun_prev]['tepat_waktu']) / $presensi_pertahun[$tahun_prev]['tepat_waktu'] * 100
										: 0; 
									if ($growth == 0) {
										$class = "fa-grip-lines";
									} else {
			...
			<div class="card text-white bg-success shadow">
				<div class="card-body card-stats">
					<div class="description">
						...
						<?php
						$persen = (!empty($total_presensi_masuk[$tahun]) && !empty($presensi_pertahun[$tahun]['terlambat_masuk']))
							? round($presensi_pertahun[$tahun]['terlambat_masuk'] / $total_presensi_masuk[$tahun], 2) * 100
							: 0;
						?>
						...
						<div class="icon me-2">
							<?php
								...
								if (!empty($presensi_pertahun[$tahun]['terlambat_masuk'])) {
									$exists = true;
									$growth = (!empty($presensi_pertahun[$tahun_prev]['terlambat_masuk']) && $presensi_pertahun[$tahun_prev]['terlambat_masuk'] != 0)
										? ($presensi_pertahun[$tahun]['terlambat_masuk'] - $presensi_pertahun[$tahun_prev]['terlambat_masuk']) / $presensi_pertahun[$tahun_prev]['terlambat_masuk'] * 100
										: 0; 
									if ($growth == 0) {
										$class = "fa-grip-lines";
									} else {
			...
			<div class="card text-white bg-warning shadow">
				<div class="card-body card-stats">
					<div class="description">
						...
						<?php
						$persen = (!empty($total_presensi_pulang[$tahun]) && !empty($presensi_pertahun[$tahun]['pulang_sebelum_waktunya']))
							? round($presensi_pertahun[$tahun]['pulang_sebelum_waktunya'] / $total_presensi_pulang[$tahun], 2) * 100
							: 0;
						?>
						...
						<div class="icon me-2">
							<?php
								...
								if (!empty($presensi_pertahun[$tahun]['pulang_sebelum_waktunya'])) {
									$exists = true;
									$growth = (!empty($presensi_pertahun[$tahun_prev]['pulang_sebelum_waktunya']) && $presensi_pertahun[$tahun_prev]['pulang_sebelum_waktunya'] != 0)
										? ($presensi_pertahun[$tahun]['pulang_sebelum_waktunya'] - $presensi_pertahun[$tahun_prev]['pulang_sebelum_waktunya']) / $presensi_pertahun[$tahun_prev]['pulang_sebelum_waktunya'] * 100
										: 0; 
									if ($growth == 0) {
										$class = "fa-grip-lines";
									} else {
		...
		<div class="col-lg-3 col-sm-6 col-xs-12 mb-4">
			<div class="card text-white bg-danger shadow">
				<div class="card-body card-stats">
					<div class="description">
						<h5 class="card-title"><?=!empty($presensi_pertahun[$tahun]['tidak_absen']) && !empty($total_jumlah_presensi[$tahun]) ? format_number($presensi_pertahun[$tahun]['tidak_absen']) .  '/' . format_number($total_jumlah_presensi[$tahun]/2) : 0?></h5>
						<?php
						$persen = (!empty($total_jumlah_presensi[$tahun]) && !empty($presensi_pertahun[$tahun]['tidak_absen'])) 
							? round($presensi_pertahun[$tahun]['tidak_absen'] / ($total_jumlah_presensi[$tahun] / 2), 2) * 100 
							: 0;
						?>
						...
						<div class="icon me-2">
							<?php
								...
								if (!empty($presensi_pertahun[$tahun]['tidak_absen'])) {
									$exists = true;
									$growth = (!empty($presensi_pertahun[$tahun_prev]['tidak_absen']) && $presensi_pertahun[$tahun_prev]['tidak_absen'] != 0)
										? ($presensi_pertahun[$tahun]['tidak_absen'] - $presensi_pertahun[$tahun_prev]['tidak_absen']) / $presensi_pertahun[$tahun_prev]['tidak_absen'] * 100
										: 0; 
									if ($growth == 0) {
										$class = "fa-grip-lines";
									} else {
