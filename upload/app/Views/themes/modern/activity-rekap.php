...
<div class="card">
	...
	<div class="card-body">
		...
		<?php if (!empty($activities) && $pending_count > 0): ?>
		<div class="row mb-3">
			<div class="col-12 text-end">
				<button type="button" class="btn btn-success" id="btn-approve-selected" disabled>
					<i class="fas fa-check me-2"></i>Terima (<span id="selected-count">0</span>)
				</button>
			</div>
		</div>
		<?php endif; ?>
				...
				<thead class="table-light">
					<tr>
						<th width="50" class="text-center">
							...
							<input type="checkbox" id="select-all-checkbox" title="Select All Pending">
							<?php endif; ?>
						</th>
						<th width="50">No</th>
		...
		<div class="alert alert-info mt-3">
			...
			Total: <strong><?= isset($pager) ? $pager->getTotal('default') : count($activities) ?></strong> activity dari 
		...
		<div class="d-flex justify-content-between align-items-center mt-3">
			<div>
				...
				?>
				<small class="text-muted">
					Menampilkan <?= $start ?> sampai <?= $end ?> dari <?= $total ?> entri
				</small>
			</div>
			<div>
