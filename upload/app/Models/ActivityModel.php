...
class ActivityModel extends \App\Models\BaseModel
{
	...
	public function getActivitiesWithPatrolsByPresensi($id_user_presensi, $tgl_masuk, $tgl_keluar)
	{
		...
		// Query all patrol scans from activity_patrol for this shift
		// Start from activity_patrol table and join to activity using id_user_presensi
		$sql = "
			SELECT 
				a.id_activity,
				a.judul_activity,
			...
			INNER JOIN activity a ON ap.id_activity = a.id_activity
