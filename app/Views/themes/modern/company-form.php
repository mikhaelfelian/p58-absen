	...
	<div class="card-body">
		...
		<form method="post" action="" class="form-company">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-8 col-md-6 col-lg-5">
					<input type="text" class="form-control" name="email" value="<?=@$company->email?>" placeholder="email1@example.com;email2@example.com">
					<small class="form-text text-muted">Pisahkan beberapa email dengan tanda titik koma (;)</small>
				</div>
			</div>
