	...
	<div class="bg-light p-4 mt-4 mb-4 rounded-3">
		<div class="d-flex justify-content-between">
			<div class="hari-tanggal">
				<?= $nama_hari[date('w')] . ', ' . date('d') . ' ' . $nama_bulan[date('n')] . ' ' . date('Y') ?></div>
			...
			<div id="step-2" class="step-container" style="display:none;">
				...
				<form id="form-activity">
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" id="judul_activity" name="judul_activity"
							placeholder="Contoh: Meeting dengan client" required>
					</div>

					<div class="mb-3">
						<label class="form-label">Deskripsi Activity <span class="text-danger">*</span></label>
						<textarea class="form-control" id="deskripsi_activity" name="deskripsi_activity" rows="4"
							placeholder="Jelaskan detail pekerjaan yang dilakukan..." required></textarea>
					</div>
					...
					<div class="mb-3">
						...
						<div id="photos-preview-container" class="mb-2">
							<!-- Photos will be added here dynamically -->
						</div>

						<!-- Camera Modal -->
						<div id="camera-container" style="display:none">
							<video id="my_camera" autoplay playsinline class="img-fluid rounded mb-2"
								style="max-height:300px; background:#000;"></video>
							<button type="button" class="btn btn-secondary btn-sm w-100 mb-2" id="btn-switch-camera">
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" id="btn-validate-qr"
					style="display:none;">Validasi</button>
			</div>
		</div>
	</div>
</div>
...
<script>
	...
	console.log('🔍 mobile-activity-home.php VERSION: 2025-10-27-FIXED');
	console.log('✅ WebcamJS code removed - using getUserMedia in main-mobile.js');
