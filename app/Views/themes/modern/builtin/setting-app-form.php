	...
	<div class="card-body">
		...
		<form method="post" action="" id="form-setting" enctype="multipart/form-data">
			<div class="tab-content">
				...
				<hr/>
				<div class="row mb-3">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Data Login</label>
					<div class="col-sm-5">
						<?=options(['name' => 'field_login'], $list_field_login, $field_login)?>
						<small>Data yang digunakan untuk login</small>
					</div>
				</div>
				<div class="row mb-3">
				...
				<hr/>
				<div class="row mb-3">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Judul Apliaksi</label>
					<div class="col-sm-5">
				...
				<div class="row mb-3">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Tampilan Data User</label>
					<div class="col-sm-5">
						<p class="mb-0">Nama User</p>
						<?=options(['name' => 'data_setelah_nama_user'], ['nip' => 'NIP', 'nama_jabatan' => 'Nama Jabatan'], @$data_setelah_nama_user)?>
						<small>Tampilan data user setelah nama. Data ini ada pada menu user di pojok kanan atas dan menu mobile</small>
					</div>
				</div>
				<div class="row mb-3">
				...
				<hr/>
				<div class="row mb-3">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Logo Dokumen PDF</label>
					<div class="col-sm-5">
						<?php
						if (!empty($logo_dokumen) && file_exists($config->imagesPath . $logo_dokumen))
						echo '<div style="margin:inherit;margin-bottom:10px"><img src="'. $config->imagesURL . $logo_dokumen . '"/></div>';
						
						?>
						<input type="file" class="file form-control" name="logo_dokumen">
							<?php if (!empty($form_errors['logo_dokumen'])) echo '<small class="alert alert-danger">' . $form_errors['logo_dokumen'] . '</small>'?>
							<small class="form-text text-muted"><strong>Gunakan file .jpg/.jpeg</strong></small>
							<div><small>Logo pada dokumen hasil ekspor .pdf</small></div>
