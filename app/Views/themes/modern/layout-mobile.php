			...
			<div style="width:100%" class="d-flex justify-content-between align-items-center">
				...
				<div class="nav-right-panel me-4">
					<div role="button" id="user-menu-nav-header">
						<?php
						$avatar_file_header = 'default.png';
						if (!empty($user['avatar'])) {
							$avatar_path_header = ROOTPATH . '/public/images/user/' . $user['avatar'];
							if (file_exists($avatar_path_header)) {
								$avatar_file_header = $user['avatar'];
							}
						}
						$avatar_url_header = base_url() . '/public/images/user/' . $avatar_file_header;
						?>
						<img src="<?=$avatar_url_header?>" role="button" style="width:32px;height:32px;max-width:32px;max-height:32px;border-radius:50%;object-fit:cover"/>
		...
		<div class="offcanvas-body sidebar-body">
			<div class="img-profile">
				...
				<div class="avatar-profile">
					<img class="rounded-circle" src="<?=base_url() . '/public/images/user/' . $file?>" width="100" height="100" style="width:100px; height:100px; object-fit:cover"/>
				</div>
...
<script>
	...
	if (typeof Html5Qrcode === 'undefined') {
		console.warn('Html5Qrcode CDN failed, trying alternative...');
