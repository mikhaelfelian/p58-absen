			...
			<div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9">
						...
						echo '<div class="input-group" style="width:440px">'
						 . options(['name' => 'waktu_masuk_awal_jam', 'class' => 'select2'], $jam_masuk, $waktu_masuk_awal[0])
						 ...
						 . options(['name' => 'waktu_masuk_akhir_jam', 'class' => 'select2'], $jam_masuk, $waktu_masuk_akhir[0])
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9">
						...
						echo '<div class="input-group" style="width:200px">'
						 . options(['name' => 'batas_waktu_masuk_jam', 'class' => 'select2'], $jam, $batas_waktu_masuk[0])
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9">
						...
						echo '<div class="input-group" style="width:200px">'
						 . options(['name' => 'batas_waktu_pulang_jam', 'class' => 'select2'], $jam, $batas_waktu_pulang[0])
